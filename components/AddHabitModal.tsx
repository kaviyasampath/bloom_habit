...
import { Habit, HabitPersonality, FrequencyType, GoalType } from '../types';
...
const AddHabitModal: React.FC<AddHabitModalProps> = ({ onClose, onAdd }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newHabit: Habit = {
      ...
      personality,
      frequency,
      goalType: 'count', // simplified for demo
      goalTarget: target,
      unit,
      createdAt: Date.now(),
    };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-pink-900/20 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white rounded-[2rem] w-full max-w-md p-8 shadow-xl border border-pink-50 overflow-y-auto max-h-[90vh] custom-scrollbar">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">New Habit Seed</h2>
